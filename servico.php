...
if (isset($_POST['submit1'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO agendausu(cod_cliente,cod_servico,data_1,horario,obs) VALUES(1,'$unha', '$data_1','$horario','$obs')");
...
<body>
    ...
    <div class="tudo">
        ...
        <div class="left">
            <div class="foto"><img id="serv" src="imagem/sunha.jpg"></div>
        </div>
